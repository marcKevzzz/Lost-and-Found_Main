 ...
 * @author QCU
 */
public final class ViewClaimLost extends javax.swing.JPanel {

    /**
     * Creates new form ViewClaimLost
     * @param id
     */
    public ViewClaimLost(int id) {
        initComponents();
          loadClaimDetails(id);
    }
    ...
    void loadClaimDetails(int id) {
        ...
        try (Connection con = DBConnection.DataBase.getConnection()) {
            String query = "SELECT claimsLost_tbl.* FROM claimsLost_tbl INNER JOIN itemreport ON claimsLost_tbl.claimId = itemreport.id WHERE itemreport.id = ?";
    ...
    private void initComponents() {
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(1200, 60));
        ...
        jPanel6.setMinimumSize(new java.awt.Dimension(1200, 500));
        jPanel6.setPreferredSize(new java.awt.Dimension(1200, 500));
        ...
        panelClaims1.setPreferredSize(new java.awt.Dimension(1200, 500));
